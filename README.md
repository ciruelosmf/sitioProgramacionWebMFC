# Sitio - Programacion Web 
- Universidad de la Punta - 2022
...
#TODO
- hacer el javascript que arme la string para el msj de whatsapp
- dejar definido el css para Restaurante y para Restaurantes
- crear artículo describiendo el sitio
- finalizar formulario para adherirse a negocio, falta opción de subir logo
